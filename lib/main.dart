...
class InputScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: HexColor("#C25185"),
      appBar: AppBar(title: Text('Blood_Sugar_Monitor')),
      body: Padding(
...
class InformationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: HexColor("#FDE8E9"),
      appBar: AppBar(title: Text('I N F O R M A T I O N')),
      body: Center(
        child: Column(
          children: [
